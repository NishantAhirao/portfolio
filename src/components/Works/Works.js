...
const Works = () => {
  return (
    <section id='works'>
        ...
        <span className='worksDesc'>Learn How To Make Portfolio Website Using React JS | Create React Portfolio Website Step by Step tutorial to make full website</span>
